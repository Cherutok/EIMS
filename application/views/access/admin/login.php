		...
		<div class="account-content">
			...
			<div class="account-box bg-inverse-dark border-0 bg-inverse-white">
				<div class="account-wrapper">
					...
					<?php echo form_open('Administrators/validate_credentials'); ?>
					...
					<div class="account-footer">
						<p class="btn btn-outline-warning"><a href="<?php echo base_url(); ?>Administrators/signup">Create an Account</a>
						</p>
					</div>
				</div>
			</div>
